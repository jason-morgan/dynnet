...
##' @aliases dynnet
##' @docType package
##' @title Latent Space Models for Static and Dynamic Networks
##' @note \pkg{dynnet} is developed by Jason W. Morgan.
##' @author Jason W. Morgan (\email{jason.w.morgan@@gmail.com})
##'
##' @references Hoff, Peter D., Adrian E. Raftery, & Mark S. Handcock (2002)
##' ``Latent Space Approaches to Social Network Analysis'', \emph{Journal of the
